...
##Keywords
Each langauge has a set of words that are reserved. They can't be used as variable names. The complete list is given here as referance. you don't need them by heart. This is just for your reference.
...
def primes_till(limit):
    numbers = {2}
    numbers.update(set(range(3, limit, 2)))
    for i in range(3, limit/2):
        numbers.difference_update(range(2*i, limit, i))
    return numbers
